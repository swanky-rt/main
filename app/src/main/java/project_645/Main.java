...
//            //Call same method to load all table:
//            //bufferManager.populateTable(File.MOVIES, filePath, -1; // this is to populate entire dataset
//            bufferManager.populateTable(File.MOVIES, filePath, 100);//movies
//            bufferManager.populateTable(File.PEOPLE, filePath, 100);//people
//            bufferManager.populateTable(File.WORKEDON, filePath, 100);// WorkedOn
//            System.out.print("file created for all these files");
//
